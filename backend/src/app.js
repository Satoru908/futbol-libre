...
app.use((req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', 
    "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://telegram.org https://cdn.jsdelivr.net; script-src-elem 'self' 'unsafe-inline' https://telegram.org https://cdn.jsdelivr.net; worker-src 'self' blob:; style-src 'self' 'unsafe-inline'; img-src * data: blob:; font-src 'self' data:; connect-src *; frame-src 'self' streamtp10.com *.streamtp10.com streamtpnew.com *.streamtpnew.com hls.com *.hls.com twitch.tv *.twitch.tv youtube.com *.youtube.com; media-src * blob: data:;"
  );
